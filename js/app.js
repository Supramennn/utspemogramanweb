...
//         title: 'Madilog',
//         author: 'Tan Malaka',
//         image: 'https://mabhak.sch.id/wp-content/uploads/2023/12/9789791683319_Madilog-Tan-Malaka-Materialisme-Dialektika-Logika.jpg',
//         description: `
...
//         Kebanyakan cerita di dalam buku ini memang bertema tentang cinta, dalam arti yang luas. Fiersa kelihatannya menulis simultan satu per satu cerita serta lagunya dan membukukannya sekaligus.
...
//         id: 'bk-009',
//         title: 'Life Lessons',
//         author: 'Dr. Elisabeth Kubler-Ross & David Kessler',
//         image: 'https://image.gramedia.net/rs:fit:0:0/plain/https://cdn.gramedia.com/uploads/items/Life_Lessons.jpg',
//         description: `
//         Seseorang melihat kehidupan dengan cara yang sangat berbeda ketika menghadapi kematian. Ia menjadi memiliki keinginan untuk mempelajari dan melakukan sesuatu supaya hidupnya menjadi lebih bermakna. Apakah kita harus menunggu sampai menjelang ajal menjemput untuk menjadikan hidup lebih bermakna? Tidak bisakah kita mempelajari dan melakukannya sekarang? Saat ini juga?

//         Dalam buku ini, Elisabeth Kübler-Ross dan David Kessler mewawancarai ratusan orang yang berada di ambang kematian, dan menuliskan seluruh pengalaman mereka. Dari pengalaman-pengalaman ini, kita akan belajar tentang cinta, kehilangan, kekuatan, rasa bersalah, ketakutan, amarah, hingga kebahagiaan. Semoga melalui buku Life Lessons ini kita tidak perlu menunggu menjelang ajal menjemput untuk membuat sebuah kehidupan menjadi lebih bermakna.
...
//         Selling Point:
//         1. Buku ini membantu memetakan dan menyembuhkan trauma yang selama ini kurang disadari, seiring memburuknya kualitas kesehatan mental kita.
//         2. Sangat cocok untuk remaja hingga dewasa yang peduli dengan mental health, dan peduli dengan karier mereka.
//         3. Dapat direkomendasikan untuk dibaca bersama-sama dengan pasangan atau anggota keluarga.
//         4. Dilengkapi dengan beberapa quesionaire yang praktis untuk membantu menyelesaikan trauma diri.
...
//         Itu sebabnya aku sudah tidak pernah berdoa lagi.
//         Bukan karena aku tidak percaya bahwa Tuhan itu ada, tapi karena aku tahu, jawabannya akan selalu tidak, dan akan tetap tidak.
